...
package com.tencent.spark.java.structurestreaming;
...
public final class JavaStructuredKafkaWordCount {
    ...
    public static void main(String[] args) throws Exception {
        ...
        Dataset<String> lines = spark
                ...
                .option("kafka.sasl.jaas.config", "org.apache.kafka.common.security.plain.PlainLoginModule required username=\"kafka\" password=\"kafka@Tbds.com\";")
                .load()
